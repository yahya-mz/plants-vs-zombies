...
public class BloverAnimations {
        ...
        var animationsDirectory = new File(GlobalSettings.getDir("graphics/Plants/Blover"));
        for (int i = 0; i < BloverAnimations.Animations.values().length; i++) {
            var animationImages = new File(animationsDirectory.getPath() + "/" + BloverAnimations.Animations.values()[i].name()).listFiles();
        ...
        public static Image[] getFrames(BloverAnimations.Animations animation) {
