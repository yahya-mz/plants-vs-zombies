...
import com.pvz.plantsvszombies.Presentation.Engines.VisualMultiplayerEngine;
...
public class MultiplayerGameView extends AbstractLevelView {
    ...
    private void setupStage() {
        try {
            ...
            Mediator.init(clientEngine, _visualEngine);
...
//bar
        ...
        HBox plantbar = createTopPlantSelectionBar(selectedPlants);
//        addHoverEffectToImages(plantbar);
        Button shoveltool = createShovelToolButton();
...
//        mainbar.setStyle("-fx-background-color: red;");-debug
        ...
        gameBoxPane.getChildren().addAll(mainbar, pause);
