...
public class RepeaterVisualObject extends AbstractPlantVisualObject {
    private RepeaterGameObject _gameObject;
    ...
    public void playAnimation(IAnimation animation) {
        super.playAnimation(animation, RepeaterAnimation.getFrames((RepeaterAnimation.Animations) animation), Duration.millis(90));
    }

    @Override
    public void spawn() {
        System.out.println("demodemo");
        playAnimation(RepeaterAnimation.Animations.STANDING);//standing
    }
}
