...
public class ConeHeadZombieGameObject extends AbstractZombieGameObject {
    ...
    public static ConeHeadZombieGameObject createConeHeadZombieGameObject(IGameEngine gameEngine, String id, Coordinate coordinate, int row, int column) {
        return new ConeHeadZombieGameObject(gameEngine, id, coordinate, row, column);
    }
    ConeHeadZombieGameObject(IGameEngine gameEngine, String id, Coordinate coordinate, int row, int column) {
