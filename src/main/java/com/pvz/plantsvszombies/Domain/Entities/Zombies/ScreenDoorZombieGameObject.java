...
public class ScreenDoorZombieGameObject extends AbstractZombieGameObject {
    ...
    public static ScreenDoorZombieGameObject createScreenDoorZombieGameObject(IGameEngine gameEngine, String id, Coordinate coordinate, int row, int column) {
        return new ScreenDoorZombieGameObject(gameEngine, id, coordinate, row, column);
    }

    ScreenDoorZombieGameObject(IGameEngine gameEngine, String id, Coordinate coordinate, int row, int column) {
