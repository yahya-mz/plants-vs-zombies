...
public class TallNutGameObject extends AbstractPlantGameObject {
    ...
    public static TallNutGameObject createTallNutGameObject(IGameEngine gameEngine, String id, Coordinate coordinate, int row, int column) {
        return new TallNutGameObject(gameEngine, id, coordinate, row, column);
    }
    TallNutGameObject(IGameEngine gameEngine, String id, Coordinate coordinate, int row, int column) {
