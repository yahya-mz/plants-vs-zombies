...
public class CoffeeBeanGameObject extends AbstractPlantGameObject implements Serializable {
    ...
    private AbstractNightPlantGameObject _appliedPlant;

    public static CoffeeBeanGameObject createCoffeeBeanGameObject(GameEngine gameEngine, String id, Coordinate coordinate, int row, int column) {
        return new CoffeeBeanGameObject(gameEngine, id, coordinate, row, column);
    }

    private CoffeeBeanGameObject(GameEngine gameEngine, String id, Coordinate coordinate,
                                 int row, int column) {
        ...
        _appliedPlant = (AbstractNightPlantGameObject) _gameEngine.getPlantAtBlock(row, column);
    }
